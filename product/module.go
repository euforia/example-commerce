...
func (m *Module) Configure(injector *dingo.Injector) {
	...
	injector.Override((*domain.ProductService)(nil), "").To(ProductService{}).In(dingo.ChildSingleton)
	injector.Override((*domain.SearchService)(nil), "").To(SearchService{}).In(dingo.ChildSingleton)
}
